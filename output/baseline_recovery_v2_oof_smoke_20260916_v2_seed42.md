...
> 생성 시각: 2026-09-16T05:34:28+00:00  
> 원본 데이터: `baseline_recovery_v2_oof_smoke_20260916_v2_seed42.csv`  
> 실험 ID: `cdf7144b49f87ea97f2d8fce4b1870af442fbb944e4f3c4f04b21374782af12b`  
> **스모크 테스트: 원본 앞 2,000행. 성능 비교에 인용하지 말 것.**  
...
| :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Phase 6: Advanced (Traffic 결측 제외) | — | 0.4729 | — | 0.5423 | — | **0.4933** | 0.5134 | +0.0201 | — | 28 |
| Phase 6: 전처리 개선 | — | 0.4713 | — | 0.5577 | — | **0.5116** | 0.5395 | +0.0279 | — | 21 |
...
| :--- | ---: | ---: | :--- | :--- | :--- | ---: |
| Phase 6: Advanced (Traffic 결측 제외) | 24 | 0.20 | [0.23, 0.17, 0.18, 0.21, 0.2] | [10, 10, 10, 25, 10] | — | 2.6 |
| Phase 6: 전처리 개선 | 30 | 0.21 | [0.25, 0.2, 0.17, 0.21, 0.28] | [10, 10, 25, 10, 10] | — | 2.7 |
...
| :--- | ---: | ---: | ---: |
| Phase 6: 전처리 개선 | 0.5116 | 0.4713 | 0.5577 |
| Phase 6: Advanced (Traffic 결측 제외) | 0.4933 | 0.4729 | 0.5423 |
